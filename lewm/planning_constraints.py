...
# Multi-View: [-0.8, 0, -0.5, -0.5, -0.4, -0.3, -0.4], [0, 1, 0.5, 0.5, 0.4, 0.7, 0.4]
...
RIGHT_ARM_NORM_MIN = np.array([-0.8, 0, -0.5, -0.5, -0.4, -0.3, -0.4], dtype=np.float64)
RIGHT_ARM_NORM_MAX = np.array([0, 1, 0.5, 0.5, 0.4, 0.7, 0.4], dtype=np.float64)
